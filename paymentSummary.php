	...
	<body>
		...
		<div class="col-25">
			...
			<?php ?>
				...
				<p><?php echo "Breakfast Set" ?><span class="quantityPay" style="color:red"><?php echo "x", $selectionquantity1; ?></span> <span class="price"><?php echo "RM", $selectiontotal1; }?></span></p>
				<hr>
				<?php if ($selectionquantity2 > 0) { ?>
				<p><?php echo "Lunch Set A" ?> <span class="quantityPay" style="color:red"><?php echo "x", $selectionquantity2; ?></span><span class="price"><?php echo "RM", $selectiontotal2; }?></span></p>
				<hr>
				<?php if ($selectionquantity3 > 0) { ?>
				<p><?php echo "Lunch Set B" ?> <span class="quantityPay" style="color:red"><?php echo "x", $selectionquantity3; ?></span><span class="price"><?php echo "RM", $selectiontotal3; }?></span></p>
				<hr>
				<?php if ($selectionquantity4 > 0) { ?>
				<p><?php echo "Lunch Set C" ?> <span class="quantityPay" style="color:red"><?php echo "x", $selectionquantity4; ?></span><span class="price"><?php echo "RM", $selectiontotal4; }?></span></p>
				<hr>
				<?php if ($selectionquantity5 > 0) { ?>
				<p><?php echo "Dinner Set" ?> <span class="quantityPay" style="color:red"><?php echo "x", $selectionquantity5; ?></span><span class="price"><?php echo "RM", $selectiontotal5; }?></span></p>
				<hr>
				<?php if ($selectionquantity6 > 0) { ?>
				<p><?php echo "Beverage of the day" ?> <span class="quantityPay" style="color:red"><?php echo "x", $selectionquantity6; ?></span><span class="price"><?php echo "RM", $selectiontotal6; }?></span></p>
				<hr>

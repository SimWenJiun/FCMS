					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO Menu(menu_item,ite_type,item_price,item_pic) VALUE('".$_POST['d_name']."','".$_POST['type']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
